    ...
    return (
        <div className="flex flex-col xl:gap-y-[2.4rem] gap-y-[2rem] ">
            ...
            <div className="relative">
                ...
                (--cl-pri)] absolute top-[50%] translate-y-[-50%] flex items-center justify-center xl:right-[0.8rem] md:right-[0.6rem] right-[0.4rem] bg-[var(--cl-pri)] rounded-[1.2rem] cursor-pointer duration-300  hover:bg-[var(--cl-second)]">
                    <Image width={30} height={30} src="/images/searchIc.svg" className="object-cover" alt="" />
                </button>
            </div>
        </div>
    )
